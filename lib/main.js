...
var _templateObject = _taggedTemplateLiteral(['(', ') at line (', ') column (', ')'], ['(', ') at line (', ') column (', ')']);
        ...
        return _this2.worker.request('job', {
          ...
          return response.map(function (_ref) {
            ...
            try {
              ...
              throw new Error(('Cannot mark location in editor for (' + ruleId + ') - ')(_templateObject, message, line, column));
            }
