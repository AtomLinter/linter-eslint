...
export default {
  ...
  activate: function() {
    ...
    // Reason: I (steelbrain) have observed that if we spawn a process while atom is starting up, it can increase startup time by several seconds,
    // But if we do this after 5 seconds, we barely feel a thing.
    setTimeout(() => {
      if (this.active) {
