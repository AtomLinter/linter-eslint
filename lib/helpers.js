...
var processMessages = exports.processMessages = function () {
  var _ref4 = _asyncToGenerator(function* (response, textEditor, showRule) {
    return Promise.all(response.map(function () {
      var _ref5 = _asyncToGenerator(function* (_ref6) {
        ...
        try {
          ...
          ret = yield generateInvalidTrace(msgLine, msgCol, msgEndLine, msgEndCol, eslintFullRange, filePath, textEditor, ruleId, message);
        }
  ...
  return function processMessages(_x14, _x15, _x16) {
...
var generateInvalidTrace = function () {
  var _ref3 = _asyncToGenerator(function* (msgLine, msgCol, msgEndLine, msgEndCol, eslintFullRange, filePath, textEditor, ruleId, message) {
  ...
  return function generateInvalidTrace(_x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
